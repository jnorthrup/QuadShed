...
class BigInt private constructor(private val sign: Boolean?, private val magnitude: Series<UInt>) : Number(),
    ...
    constructor(value: Long) : this(
        ...
        magnitude = if (value.z) emptyUIntSeries() else {
    ...
    private constructor(
        ...
        magnitude = if (value.z) emptyUIntSeries() else value.let { absValue ->
    ...
    constructor(value: String) : this(
        ...
        magnitude = if (value.isEmpty()) emptyUIntSeries() else {
...
//        0b000001 as big endian byte[] looks like: [0, 0, 0, 1]
    ...
    companion object {
        ...
        val ZERO = BigInt(null, emptyUIntSeries())
        val ONE = BigInt(1)
        val TWO = BigInt(2UL)
        val TEN = BigInt(10U)
...
fun<V> Series<V>.reversed() = object : Series<V> {
    override val a: Int get() = this@reversed.a
    override val b: (Int) -> V get() = { this@reversed.b(a - 1 - it) }
}
